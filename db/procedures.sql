...
DELIMITER //  
CREATE PROCEDURE CreateThread (OUT thread_id INTEGER, OUT message_id INTEGER, IN thread_name CHAR(255), IN board_id INTEGER, IN author CHAR(255), IN body TEXT, IN audio TEXT, IN video TEXT)  -- description: a.k.a. new thread's first message;
LANGUAGE SQL  
DETERMINISTIC  
...
BEGIN  
    ...
    INSERT INTO messages VALUES(NULL, author, body, NULL, NULL, NULL);
...
CREATE PROCEDURE CreateMessage (OUT message_id INTEGER, IN parent_id INTEGER, IN thread_id INTEGER, IN author CHAR(255), IN body TEXT, IN audio TEXT, IN video TEXT)
LANGUAGE SQL
DETERMINISTIC
SQL SECURITY DEFINER
COMMENT 'Create message with body in thread'
BEGIN
    INSERT INTO messages VALUES(NULL, author, body, NULL, audio, video);
