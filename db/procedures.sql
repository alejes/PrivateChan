...
DELIMITER //  
CREATE PROCEDURE CreateThread (OUT thread_id INTEGER, OUT message_id INTEGER, IN thread_name CHAR(255), IN board_id INTEGER, IN author CHAR(255), IN body TEXT, IN image TEXT, IN audio TEXT, IN video TEXT)  -- description: a.k.a. new thread's first message;
LANGUAGE SQL  
DETERMINISTIC  
...
BEGIN  
    ...
    INSERT INTO messages VALUES(NULL, author, body, NULL, image, audio, video);
...
CREATE PROCEDURE CreateMessage (OUT message_id INTEGER, IN parent_id INTEGER, IN thread_id INTEGER, IN author CHAR(255), IN body TEXT, IN image TEXT, IN audio TEXT, IN video TEXT)
LANGUAGE SQL
DETERMINISTIC
SQL SECURITY DEFINER
